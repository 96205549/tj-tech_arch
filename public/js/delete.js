...
/*
$(function () {
    $('a[data-confirmP]').click(function (ev) {
        var href = $(this).attr('href');
                        ...
                        '<div class="modal-dialog">'+
                            '<div class="modal-content">'+
                                '<div class="modal-header">'+
                                    ...
                                    '<h3 id="dataConfirmLabel" class="text-info">Merci de confirmer</h3>'+
                                '</div>'+
                                '<div class="modal-body">Voulez-vous supprimer <b class=\'whatfaq\'></b>? <span class="text-warning">Tous les utilisateurs de ce profile seront supprim&eacute;</span></div>'+
                                '<div class="modal-footer">'+
                                    '<a class="btn btn-danger" id="dataConfirmOK">Oui</a>'+
                                    '<button class="btn" data-dismiss="modal" aria-hidden="true">Non</button>'+
                                '</div>'+
